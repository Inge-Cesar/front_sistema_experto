  ...
  return (
    <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
      ...
      <nav style={{ paddingTop: '20px' }}>
        ...
        <NavLink to="/swaps" className={({ isActive }) => `nav-item ${isActive ? 'active' : ''}`}>
          <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path></svg>
          Permutas
        </NavLink>
